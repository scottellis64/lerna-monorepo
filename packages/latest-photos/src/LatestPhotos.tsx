...
import { ImageList, ImageListItem, Typography, useMediaQuery, useTheme } from '@mui/material';
...
export const LatestPhotos = () => {
  ...
  const cols = useMemo<number>(() => isSmall ? 1 : isMedium ? 2 : isLarge ? 3 : 4,
    [isSmall, isMedium, isLarge]);

  return (
    <>
      <Typography variant='h6' fontWeight={100} mt={2} mb={2}>Latest Photos</Typography>
      <ImageList cols={cols} rowHeight={100}>
        {itemData.map((item) => (
